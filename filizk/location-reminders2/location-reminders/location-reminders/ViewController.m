...
//@property(nonatomic) enum LocationRemindersError lr_error;
...
//    }];
    ...
    //HOMEWORK WEEK9HW2
    //enum LocationRemindersError lr_error = error2;
    NSString *domain = @"LocationRemindersErrors";
    NSInteger code = error1;
    ...
    switch (errorCode.integerValue) {
        case 100: //this is just an assumed error code
            ...
            break;
        case 200: //this is just an assumed error code
            code = error2;
            userInfo = @{NSLocalizedDescriptionKey: NSLocalizedString(@"Operation was unsuccessful.", nil),
                         NSLocalizedFailureReasonErrorKey: NSLocalizedString(@"The client and server could not agree on a supported authentication type", nil),
                         NSLocalizedRecoverySuggestionErrorKey: NSLocalizedString(@"Try again later", nil)};
            break;
        case 300: //this is just an assumed error code
            code = error3;
            userInfo = @{NSLocalizedDescriptionKey: NSLocalizedString(@"Operation was unsuccessful.", nil),
                         NSLocalizedFailureReasonErrorKey: NSLocalizedString(@"The file operation failed because the file does not exist.", nil),
                         NSLocalizedRecoverySuggestionErrorKey: NSLocalizedString(@"No Suggesstions", nil)};
            break;
        case 400: //this is just an assumed error code
            code = error4;
            userInfo = @{NSLocalizedDescriptionKey: NSLocalizedString(@"Operation was unsuccessful.", nil),
                         NSLocalizedFailureReasonErrorKey: NSLocalizedString(@"The file operation failed because it does not have permission to read the file.", nil),
                         NSLocalizedRecoverySuggestionErrorKey: NSLocalizedString(@"Provide necessary permissions.", nil)};
            break;
        case 500: //this is just an assumed error code
            code = error5;
            userInfo = @{NSLocalizedDescriptionKey: NSLocalizedString(@"Operation was unsuccessful.", nil),
                         NSLocalizedFailureReasonErrorKey: NSLocalizedString(@"The secure connection failed for an unknown reason.", nil),
                         NSLocalizedRecoverySuggestionErrorKey: NSLocalizedString(@"None", nil)};
            break;
    }
